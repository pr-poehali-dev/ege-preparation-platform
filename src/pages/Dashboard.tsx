      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="border-border/50 bg-card/50 backdrop-blur">
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { name: 'Группа А (Математика)', students: 28, avgScore: 89 },
                { name: 'Группа Б (Физика)', students: 24, avgScore: 85 },
                { name: 'Группа В (Химия)', students: 32, avgScore: 92 },
              ].map((group, index) => (
        ...
        <Card className="border-border/50 bg-card/50 backdrop-blur">
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                { student: 'Иванов Петр', task: 'Теория вероятности', urgent: true },
                { student: 'Сидорова Мария', task: 'Квантовая физика', urgent: false },
                { student: 'Петров Алексей', task: 'Органика', urgent: true },
                { student: 'Козлова Анна', task: 'Генетика', urgent: false },
              ].map((item, index) => (
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Card className="border-border/50 bg-card/50 backdrop-blur">
        ...
        <CardContent>
          <div className="space-y-4">
            {[
              { label: 'Выполненных заданий (сегодня)', value: 156, max: 200 },
              { label: 'Активных пользователей', value: 243, max: 384 },
              { label: 'Использование хранилища', value: 68, max: 100 },
              { label: 'API запросов (за час)', value: 1847, max: 2000 },
            ].map((item, index) => (
      ...
      <header className="sticky top-0 z-50 border-b border-border/50 bg-background/80 backdrop-blur-xl">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Tabs value={currentRole} onValueChange={(value) => handleRoleChange(value as Role)}>
